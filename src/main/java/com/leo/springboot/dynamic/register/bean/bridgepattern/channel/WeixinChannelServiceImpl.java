 ...
 **/
@Name(value = "weixin")
public class WeixinChannelServiceImpl extends AbstractChannelService {

    @Autowired
    private OrderService orderService;

    public WeixinChannelServiceImpl(PayModeService payModeService) {
    ...
    public String doPay(String uId, BigDecimal amount) {
        ...
        //发起支付&返回第三方支付请求参数
        return payModeService.pay(uId, orderId, amount, "weixin");
    }
